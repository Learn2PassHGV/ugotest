...
interface StrategicEventLogisticsProps {
  onNavigateToHomeAndBook?: (journeyType: string) => void;
}

export function StrategicEventLogistics({ onNavigateToHomeAndBook }: StrategicEventLogisticsProps) {
  ...
  const eventCards = [
    {
      title: "Shuttle Services & High-Frequency Travel",
      brief: "Smooth, efficient group travel running high-frequency loops between key transit hubs, hotels, and event venues. We make moving large crowds straightforward for stadiums, festivals, and business parks.",
      bgClass: "bg-[#050C1A] text-white border-white/5 shadow-2xl",
      btnClass: "bg-amber-500 hover:bg-amber-600 text-slate-950",
      ctaText: "Book Event Shuttles",
      bullets: [
        "Reliable shuttle bus and coach hire programmes for major sports stadiums and music festivals",
        "Comfortable, high-frequency transport loops between railway stations, local hotels, and venues",
        "Flexible corporate shuttle services tailored to local business parks and commuter routes"
      ],
      icon: <Activity className="w-8 h-8 text-amber-500 mb-6" />
    },
    {
      title: "Conferences, Exhibitions & Corporate Events",
      brief: "Executive travel for industry summits, direct exhibition transfers, and premium private hospitality outings. Our immaculate, unbranded luxury vehicles offer complete discretion for VIPs and guests.",
      ...
      bullets: [
        "Immaculate unbranded luxury minibuses and coaches for complete VIP discretion",
        "Co-ordinated travel schedules matched perfectly to panels, speaker times, and exhibition hours",
        "Premium transport for prestigious race days, Royal Ascot, Henley Regatta, or corporate golf events"
      ],
      icon: <Briefcase className="w-8 h-8 text-amber-500 mb-6" />
    },
    {
      title: "Reliable Backup & Flexible Journey Management",
      brief: "Complete scheduling protection. Our live human dispatch team monitors regional traffic in real-time, adjusting routes instantly to bypass delays and keeping standby vehicles ready to deploy.",
      bgClass: "bg-[#050C1A] text-white border-white/5 shadow-2xl",
      btnClass: "bg-amber-500 hover:bg-amber-600 text-slate-950",
      ctaText: "View Our Event Fleet",
      bullets: [
        "Live traffic monitoring and immediate route changes to bypass congestion and hold-ups",
        "Standby vehicles and active local crews ready to protect your schedule from unexpected delays",
        "Direct phone communication with our family-run operations desk for instant schedule updates"
      ],
      icon: <Shield className="w-8 h-8 text-amber-500 mb-6" />
    }
  ];
  ...
  return (
    ...
    >
      {/* 1. HERO SECTION (using crisp light porcelain background #F9F9FB) */}
        ...
        <div className="max-w-5xl mx-auto px-6 relative z-10 text-center">
          ...
          <div className="service-badge-load inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-slate-900/5 border border-slate-900/15 mb-6 select-none shadow-sm">
            ...
            <span className="font-mono text-[9px] md:text-10px font-extrabold uppercase tracking-[0.25em] text-[#050C1A]">
              TAILORED GROUP TRAVEL MANAGEMENT
            </span>
          </div>
          ...
          <h1 
            ...
            itemProp="headline"
          >
            Luxury Coach &amp; Minibus Hire for Corporate Events, Conferences and Race Days
          </h1>
          ...
          <p className="service-subtext-load font-sans text-slate-650 font-light text-base md:text-xl leading-relaxed max-w-3xl mx-auto mb-10">
            Reliable, stress-free transport for large-scale corporate gatherings, major exhibitions, sports tournaments, and prestigious private hospitality outings across the UK.
          </p>

          {/* FLEET CO-ORDINATION PROTOCOL BLOCK */}
          <div className="service-subtext-load bg-slate-950 text-white border border-white/5 p-6 md:p-8 rounded-2xl max-w-3xl mx-auto my-8 shadow-2xl relative text-left">
            ...
            <p className="font-serif text-sm md:text-base leading-relaxed text-slate-200 italic font-light text-center sm:text-left">
              "We take the chaos out of event travel. Whether you are arranging corporate hospitality for Royal Ascot, managing an international conference, or moving thousands of guests at a stadium venue, our family-run team handles every detail with absolute precision so your passengers enjoy a seamless, comfortable journey."
            </p>
            {/* Thin signature orange accent underline rule */}
          ...
          <div className="service-subtext-load max-w-3xl mx-auto my-10 bg-slate-150/40 border border-slate-200 p-6 rounded-2xl">
            <p className="font-sans text-xs md:text-sm text-slate-600 leading-relaxed font-light">
              UGO designs, executes, and actively monitors complex event ground logistics, deploying a versatile fleet of unbranded luxury minibuses, midis, and grand tourers to manage high-volume traveler movements for premium corporate and civic sectors.
            </p>
          </div>

          <div className="service-buttons-load flex flex-col sm:flex-row items-center justify-center gap-4">
            <button
              onClick={() => handleActionClick("Strategic Event Logistics")}
            ...
            >
              Enquire About Event Travel
            </button>
            <button
              onClick={() => {
                const kpiSection = document.getElementById("event-kpi-table");
                if (kpiSection) {
      ...
      {/* 2. THREE-CARD EVENT SYSTEM CAPABILITY GRID */}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-20">
            ...
            <h2 className="reveal-layer-hidden reveal-sec-header font-serif text-3xl md:text-4.5xl text-slate-950 font-medium leading-tight">
              Event Coach &amp; Minibus Hire | Professional Group Travel
            </h2>
                ...
                <div>
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-mono text-[9px] font-bold tracking-widest uppercase text-slate-400">
                      Event Operations Control Board
                    </span>
      ...
      {/* 3. SEMANTIC INFORMATION COMPLIANCE SEC */}
      <section className="reveal-layer-hidden reveal-sec-desc py-16 bg-[#FAFAFC] border-b border-slate-200">
        <div className="max-w-5xl mx-auto px-6 text-center">
          <p className="font-sans text-xs text-slate-500 leading-relaxed font-light tracking-wide">
            UGO provides award-winning expertise in corporate event coach hire and luxury minibus management across the UK. We specialise in conference delegate transport, festival shuttle services, and executive travel for sports venues and major exhibitions. Our family-run team ensures your venue transport stays punctual, organised, and cost-effective, providing premium co-ordination support for everything from private hospitality outings to large-scale business programmes.
          </p>
        </div>
      </section>

      {/* 4. AIEO METRIC REFERENCE TABLE */}
      <section id="event-kpi-table" className="py-24 border-b border-slate-200 bg-[#F9F9FB]">
        <div className="max-w-7xl mx-auto px-6">
              ...
              <table className="w-full border-collapse text-left min-w-[700px]">
                <thead>
                  <tr className="border-b border-slate-200 bg-slate-50 text-slate-500 font-mono text-[10px] md:text-xs uppercase tracking-wider">
                    <th className="py-6 px-6 md:px-8 font-semibold">Event Transport Category</th>
                    <th className="py-6 px-6 md:px-8 font-semibold">Dedicated Fleet Specifications</th>
                    <th className="py-6 px-6 md:px-8 font-semibold">On-Site Management &amp; Support</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100 text-slate-700">
                  <tr className="reveal-layer-hidden reveal-sec-node-1 hover:bg-slate-50/50 transition-colors duration-200 text-sm">
                    ...
                    <td className="py-6 px-6 md:px-8 font-sans font-light">
                      Unbranded luxury minibuses (10 to 16 seats) and executive midis perfect for delegates and speakers
                    </td>
                    <td className="py-6 px-6 md:px-8 font-sans font-light text-slate-600">
                      Real-time journey monitoring, passenger support, and a single point of contact with our family-run dispatch desk
                    </td>
                  </tr>
                  <tr className="reveal-layer-hidden reveal-sec-node-2 hover:bg-slate-50/50 transition-colors duration-200 text-sm">
                    <td className="py-6 px-6 md:px-8 font-semibold text-slate-950">
                      Shuttle Services &amp; High-Frequency Loops
                    </td>
                    <td className="py-6 px-6 md:px-8 font-sans font-light">
                      Modern coaches and high-capacity grand tourers (49 to 53 seats) for stadium, festival, or hotel shuttles
                    </td>
                    <td className="py-6 px-6 md:px-8 font-sans font-light text-slate-600">
                      Experienced on-site travel marshals, dedicated loading layouts, and live route management to avoid delays
                    </td>
                  </tr>
                  <tr className="reveal-layer-hidden reveal-sec-node-3 hover:bg-slate-50/50 transition-colors duration-200 text-sm">
                    <td className="py-6 px-6 md:px-8 font-semibold text-slate-950">
                      VIP Private Hospitality &amp; Days Out
                    </td>
                    <td className="py-6 px-6 md:px-8 font-sans font-light">
                      Immaculate, unbranded Mercedes-Benz Sprinters and luxury vehicles for complete confidentiality
                    </td>
                    <td className="py-6 px-6 md:px-8 font-sans font-light text-slate-600">
                      Discreet service for Royal Ascot, Henley Regatta, corporate golf days, and prestigious VIP transport
                    </td>
                  </tr>
                </tbody>
              </table>
            ...
            >
              ...
              >
                <span 
                  ...
                  itemProp="name"
                >
                  How do you manage unexpected traffic delays or route blockages during a major event?
                </span>
                <ChevronDown 
                  className={cn(
              ...
              >
                <div 
                  ...
                  itemProp="text"
                >
                  Every event is monitored in real-time by our family-run dispatch base. Our co-ordinators maintain direct contact with our drivers, instantly adjusting routes to bypass congestion and protect your arrival times.
                </div>
              </div>
            </div>
            ...
            >
              ...
              >
                <span 
                  ...
                  itemProp="name"
                >
                  Do you provide on-site team members to help coordinate passenger loading?
                </span>
                <ChevronDown 
                  className={cn(
                    "w-5 h-5 text-slate-400 shrink-0 transition-transform duration-300",
              ...
              >
                <div 
                  ...
                  itemProp="text"
                >
                  Yes, for large-scale events, we can provide dedicated on-site travel marshals and co-ordinators to manage vehicle departures, boarding lanes, and general passenger support.
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 6. HIGH CONVERTING CORPORATE CTA PANEL */}
